...
export function Auth() {
  ...
  const [loginForm, setLoginForm] = useState<LoginForm>({ identifier: '', password: '', rememberMe: false });
      ...
      <div className="form-side">
        ...
        <div className={`auth-form${mode === 'login' ? ' active' : ''}`}>
          ...
          <div className="login-actions">
            ...
            <button className="inline-link forgot-link" type="button">Forgot Password?</button>
          </div>

          <p className="social-label">Log in with:</p>
        ...
        <div className={`auth-form${mode === 'signup' ? ' active' : ''}`}>
          ...
          <p className="social-label">Create using:</p>
          <div className="social-btns">
            <button className="social-btn">Google</button>
            <button className="social-btn">Apple</button>
          </div>
